...
public class Elevator extends SubsystemBase {
  ...
  public Elevator() { //Creates a new Elevator.
    ...
    // Set PID gains
    config.closedLoop // pid loop to control elevator elevating rate
    ...
    //TODO: Encoder should be configured (position conversion factor), based on cad, in order to use the feedback
