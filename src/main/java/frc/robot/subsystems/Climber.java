...
public class Climber extends SubsystemBase {
  ...
  public Climber() {
    ...
    climb2Motor.configure(
        climber2Config, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
  }
  ...
  private SparkMaxConfig createClimber2Config() {
    ...
    climber2Config
        ...
        .positionConversionFactor(
            climberConstants.climberPCF) // climber contants means the variables at the top :)
        .velocityConversionFactor(climberConstants.climberPCF / 60.0d);
    ...
    climber2Config
        .smartCurrentLimit(climberConstants.climber2CurrentLimit)
