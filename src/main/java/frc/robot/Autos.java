...
public class Autos {
    ...
    public AutoRoutine LeftTwoPiece() {
        ...
        AutoTrajectory leftStartToleftFar = routine.trajectory("leftStart-leftFar"); // Drives from staging line to lineup start point
        AutoTrajectory leftFarToleftStation = routine.trajectory(
                "leftFar-leftStation"); // Drives from Far Left Segment Right Branch, to Station
        AutoTrajectory leftStationToleftClose = routine.trajectory("leftStation-leftClose"); // Drives from station to lineup start point
        ...
        canAlign
                ...
                .onTrue(
                        alignToRightCoral
                                ...
                                .andThen(score().withName("Score First Piece").withTimeout(5))
                                .andThen(leftFarToleftStation.cmd().withName("Drive to Station")
                                        .alongWith(elevator.setPosition(ElevatorState.HOME)))
        ...
        centerStart_centerFar
                ...
                .onTrue(
                        elevator
                                ...
                                .andThen(elevator.elevatorAuto(ElevatorState.ALGAELOW))
                                .andThen(coral.reverseCommand().withTimeout(2))
                                ...
                                .andThen(
                                        coral
                                                ...
                                                .andThen(centerStarttoLeftStation.cmd()
                                                        .withName("Drive to Left Station"))
                                                .withName("Score and Move Sequence")));
                                ...
                                .andThen(
                                        coral
                                                ...
                                                .andThen(centerFarToRightStation.cmd()
                                                        .withName("Drive to Right Station"))
                                                .withName("Score and Move Sequence")));
