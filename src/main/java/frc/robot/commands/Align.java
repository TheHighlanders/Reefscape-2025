...
public class Align extends Command {
  ...
  public void initialize() {
    ...
    xController.reset(currentPose.getX(), 0);//-currentSpeeds.vxMetersPerSecond);
    yController.reset(currentPose.getY(), 0);//-currentSpeeds.vyMetersPerSecond);
    rotController.reset(
        currentPose.getRotation().getRadians(), 0);//-currentSpeeds.omegaRadiansPerSecond);
  }
